...
export default function PagePreloader() {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-[99999] flex items-center justify-center bg-[#292722] text-paper overflow-hidden select-none"
      style={{ willChange: 'transform' }}
      aria-label="Loading Studio Oral Vitta"
    >
      ...
      >
        ...
        <div
          ref={logoRef}
          className="relative w-20 h-20 sm:w-24 sm:h-24 bg-paper rounded-2xl shadow-2xl p-2.5 flex items-center justify-center mb-6 border border-[#C9B486]/40"
        >
          <Image
            src="/images/logo.png"
